...
import { 
  ArrowLeft, ChevronRight, Wand2, History, PieChart, Settings2, Layers, BrainCircuit, MessageSquare, Shield
} from 'lucide-react';
    ...
    <div className="h-full flex flex-col bg-[#0A0A0C] relative font-sans">
      ...
      <div className="h-20 border-b border-white/5 shrink-0 flex items-center justify-between px-6 sm:px-10 relative z-20">
         <div className="flex items-center gap-2 text-xs font-bold text-white/50">
            ...
            <ChevronRight className="w-3 h-3" />
            <span className="text-amber-500">Studio Dashboards</span>
         </div>
            ...
            <div className="max-w-5xl mx-auto space-y-8">
               ...
               <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
                  <div>
                     <h1 className="text-3xl font-black text-white flex items-center gap-3 mb-2">
                        <PieChart className="w-8 h-8 text-amber-500" /> Studio Dashboards
                     </h1>
                     <p className="text-sm text-white/50 font-light">
                        Data visualization, relatórios dinâmicos e painéis gerenciais.
                     </p>
                  </div>
               ...
               {activeTab === 'nexus' && (
                  <div className="animate-in fade-in slide-in-from-bottom-4 duration-500 max-w-3xl mx-auto text-center mt-12">
                     ...
                     <h2 className="text-2xl font-light text-white mb-4">O que deseja monitorar?</h2>
                     <p className="text-sm text-white/40 font-light mb-8 max-w-lg mx-auto leading-relaxed">
                        Indique as métricas que quer analisar. O Nexus vai determinar os melhores gráficos, conectar com as APIs necessárias e gerar um painel visual unificado.
                     </p>
                  ...
                  <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
                     ...
                     <div>
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                           {["Painel Financeiro","Vendas","Analytics","RH"].map((mode, i) => (
                     ...
                     <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                        ...
                        <div className="space-y-6">
                           <div className="glass-panel p-6 rounded-3xl space-y-5">
                              {[{"label":"Motor de BI","options":["Nexus Analytics Core","GPT-4o (Data Analysis)"]},{"label":"Fonte de Dados","options":["PostgreSQL","Firebase","Google Analytics","Stripe"]}].map((setting, i) => (
                                <div key={i}>
