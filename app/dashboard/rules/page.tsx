    ...
    <div className="h-full overflow-y-auto custom-scrollbar p-6 lg:p-10 relative bg-[#090A0F]">
      ...
      <div className="max-w-5xl mx-auto w-full relative z-10">
        ...
        <div className="flex items-center gap-4 mb-2">
          ...
          <div>
            <h1 className="text-3xl font-bold text-white tracking-tight">Regras & Diretrizes</h1>
            <p className="text-white/50 text-sm mt-1">Configurações globais e limites de atuação.</p>
          </div>
        </div>
