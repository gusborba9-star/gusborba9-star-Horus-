...
export default function IntegraesPage() {
  return (
    <div className="h-full flex flex-col bg-[#0A0A0C] relative font-sans">
      ...
      <div className="h-24 px-6 sm:px-10 border-b border-white/5 shrink-0 flex items-center justify-between relative z-20 bg-[#0A0A0C]/50 backdrop-blur-xl">
         <div>
            ...
            <p className="text-xs sm:text-sm text-white/40 mt-2 font-light max-w-2xl">Conectores ativos no seu ecossistema. O Hórus orquestra dados de qualquer plataforma.</p>
         </div>
         ...
         <div className="max-w-7xl mx-auto space-y-6">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-between">
               <div className="relative flex-1 max-w-md">
                  ...
                  <input 
                     type="text" 
                     placeholder="Buscar em Integrações..." 
            ...
            <div className="glass-panel rounded-3xl p-16 text-center border border-white/5 mt-8">
               ...
               <h2 className="text-xl font-light text-white mb-3">Nenhum dado encontrado em Integrações</h2>
               <p className="text-sm text-white/40 font-light max-w-md mx-auto mb-8">
                  O módulo Integrações está ativo e pronto para receber dados ou ser orquestrado pelo Nexus Cognitive Engine.
               </p>
